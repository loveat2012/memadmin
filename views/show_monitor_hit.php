...
?>
<div id="monitorctrl">
    <div id="autofresh"><span id="repaf"><span id="ausrep"></span><?php echo $langs['sautof_des']; ?></span></span><span
            id="lastaftit"><?php echo $langs['showmo_lasttime']; ?></span><span
        ...
        if ($list == false)
            ...
            foreach ($monitorlist[1] as $key => $value) {
                ...
                <div id="<?php echo $value; ?>hit" class="monitordiv drag_<?php echo $i; ?>">
                    <div id="<?php echo $value; ?>tit"
                         class="movetit"><?php echo strtoupper($value) . " " . $langs['hitmo_hittit']; ?></div>
                    <div id="<?php echo $value; ?>hitdata" class="hitdata">
                        <div class="alltit">
                            <div id="cmd_<?php echo $value; ?>_tit"
                                 class="thetit"><?php echo $langs['hitmo_cmdcount']; ?></div>
                            <div id="<?php echo $value; ?>_hits_tit"
                                 class="thetit"><?php echo $langs['hitmo_hitcount']; ?></div>
                            <div id="<?php echo $value; ?>_misses_tit"
                                 class="thetit"><?php echo $langs['hitmo_misscount']; ?></div>
                            <div id="<?php echo $value; ?>_hit_rate_tit"
                                 class="thetit"><?php echo $langs['hitmo_hitrate']; ?></div>
                        </div>
                        <div class="allvalue">
