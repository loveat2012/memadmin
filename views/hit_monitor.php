...
if ($type == 'con') {
    if (!$memm->MemConnect($type, $curcon))
        ...
        if ($list == false) {
                ...
                <div id="checktableframe1">
                    <table id="checktable1" class="checktable" cellpadding="2" cellspacing="1">
                        ...
                        if (!$memm->is_Tykyo($type, $num, $curcon)) {
                            ...
                            ?>
                            <tr><label for="checkbox_get">
                                    <td class="checktd"><input type="checkbox" class="checkmo" name="checkbox_monitor[]"
                                                               id="checkbox_get" value="get"/></td>
                                    <td><?php echo $langs['hm_gettit']; ?></td>
                                </label></tr>
                            <tr><label for="checkbox_set">
                                    <td class="checktd"><input type="checkbox" class="checkmo" name="checkbox_monitor[]"
                                                               id="checkbox_set" value="set"/></td>
                                    <td><?php echo $langs['hm_settit']; ?></td>
                                </label></tr>
                            <tr><label for="checkbox_delete">
                                    <td class="checktd"><input type="checkbox" class="checkmo" name="checkbox_monitor[]"
                                                               id="checkbox_delete" value="delete"/></td>
                                    <td><?php echo $langs['hm_deletetit']; ?></td>
                                </label></tr>
                            <?php
                        }
                        ?>
            ...
            <div id="checkctrl">
                <a id="seall" href="javascript:;"><?php echo $langs['statsmo_sall']; ?></a><a id="ceall"
                                                                                              href="javascript:;"><?php echo $langs['statsmo_call']; ?></a><a
                    id="opall" href="javascript:;"><?php echo $langs['statsmo_oall']; ?></a>
            </div>
            <div id="gomonitor">
                    ...
                    <div id="checktableframe1">
                        <table id="checktable1" class="checktable" cellpadding="2" cellspacing="1">
                            ...
                            if (!$memm->is_Tykyo($type, $li, $curcon)) {
                                ...
                                ?>
                                <tr><label for="checkbox_get">
                                        <td class="checktd"><input type="checkbox" class="checkmo"
                                                                   name="checkbox_monitor[]" id="checkbox_get"
                                                                   value="get"/></td>
                                        <td><?php echo $langs['hm_gettit']; ?></td>
                                    </label></tr>
                                <tr><label for="checkbox_set">
                                        <td class="checktd"><input type="checkbox" class="checkmo"
                                                                   name="checkbox_monitor[]" id="checkbox_set"
                                                                   value="set"/></td>
                                        <td><?php echo $langs['hm_settit']; ?></td>
                                    </label></tr>
                                <tr><label for="checkbox_delete">
                                        <td class="checktd"><input type="checkbox" class="checkmo"
                                                                   name="checkbox_monitor[]" id="checkbox_delete"
                                                                   value="delete"/></td>
                                        <td><?php echo $langs['hm_deletetit']; ?></td>
                                    </label></tr>
                                <?php
