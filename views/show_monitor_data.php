...
?>
    ...
    ?>
    <div id="monitorctrl">
        <div id="autofresh"><span id="repaf"><span id="ausrep"></span><?php echo $langs['sautof_des']; ?></span></span>
            <span id="lastaftit"><?php echo $langs['showmo_lasttime']; ?></span><span
                id="lasttime"><?php echo $langs['scon_nohave']; ?></span><span
                id="afstit"><?php echo $langs['showmo_aftit']; ?></span><span id="sein"><input name="afs" id="afs"
                                                                                               type="text"/><?php echo $langs['con_se']; ?></span><input
                id="startaf" class="but" name="startaf" type="button" value="<?php echo $langs['showmo_afstart']; ?>"/>
        </div>
        ...
        if ($monitorlist[0]['type'] == 'con') {
            ...
            <div id="drag_1" class="monitordiv">
                ...
                <table class="checktable" cellpadding="2" cellspacing="1">
                    ...
                    <tr>
                        <td class="argname">curr_items</td>
                        <td class="argdes"><?php echo $langs['cs_curr_items']; ?></td>
                        <td class="argvalue"><span id="data_curr_items"
                                                   class="glospan"><?php echo $statslist['curr_items']; ?></span></td>
                    </tr>
                    <tr>
                        <td class="argname">bytes</td>
                        <td class="argdes"><?php echo $langs['cs_bytes']; ?></td>
                        <td class="argvalue"><span id="data_bytes"
                                                   class="glospan"><?php echo $statslist['bytes']; ?></span></td>
                    </tr>
                    <tr>
                        <td class="argname">active_slabs</td>
                        <td class="argdes"><?php echo $langs['slabs_active_slabs']; ?></td>
                        <td class="argvalue"><span id="data_active_slabs"
                                                   class="glospan"><?php echo $slablist['active_slabs']; ?></span></td>
                    </tr>
                    <tr>
                        <td class="argname">total_malloced</td>
                        <td class="argdes"><?php echo $langs['slabs_total_malloced']; ?></td>
                        <td class="argvalue"><span id="data_total_malloced"
                                                   class="glospan"><?php echo $slablist['total_malloced']; ?></span>
                        </td>
                    </tr>
                </table>
            ...
            <div id="drag_2" class="monitordiv">
                ...
                <table class="checktable" cellpadding="2" cellspacing="1">
                    ...
                    ?>
                    <tr id="lostmem">
                        <td id="lostmemtd" classs="argname" colspan="2"><?php echo $langs['showmo_data_lostmem']; ?> (
                            total_chunks * chunk_size - mem_requested )
                        </td>
                        <td class="argvalue"><span id="data_lostmem" class="glospan"><?php echo $lostmem; ?></span></td>
                </table>
            </div>
            <?php
            ...
            <div id="drag_1" class="monitordiv">
                ...
                <table class="checktable" cellpadding="2" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="argdes"><?php echo $langs['cs_curr_items']; ?></td>
                        <td class="argvalue"><span id="data_curr_items"
                                                   class="glospan"><?php echo $statslist[$monitorlist[0]['conid']]['curr_items']; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="argname">bytes</td>
                        <td class="argdes"><?php echo $langs['cs_bytes']; ?></td>
                        <td class="argvalue"><span id="data_bytes"
                                                   class="glospan"><?php echo $statslist[$monitorlist[0]['conid']]['bytes']; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="argname">active_slabs</td>
                        <td class="argdes"><?php echo $langs['slabs_active_slabs']; ?></td>
                        <td class="argvalue"><span id="data_active_slabs"
                                                   class="glospan"><?php echo $slablist[$monitorlist[0]['conid']]['active_slabs']; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="argname">total_malloced</td>
                        <td class="argdes"><?php echo $langs['slabs_total_malloced']; ?></td>
                        <td class="argvalue"><span id="data_total_malloced"
                                                   class="glospan"><?php echo $slablist[$monitorlist[0]['conid']]['total_malloced']; ?></span>
                        </td>
                    </tr>
                </table>
