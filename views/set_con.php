...
?>
    ...
    <body>
    <div id="sc_top"><?php echo $langs['set_con_title']; ?><span id="logout"><a
                href="index.php?action=logout"><?php echo $langs['exit']; ?></a></span></div>
    <div id="sc_main">
        <div id="sc_hlist">
            <div id="sc_l_tit"> <?php echo $langs['set_con_listtit']; ?>
                <div id="listm">
                    <div id="sidetreecontrol"><a id="tc1" href="javascript:;"></a><a id="tc2" href="javascript:;"></a>
                    </div>
                    ...
                    <div id="showconmenu">
                        ...
                        <div id="saveclear">
                            <ul>
                                <li><a id="clearlist" href="javascript:;"><?php echo $langs['con_clearlist']; ?></a>
                                </li>
            ...
            <div id="gonext">
                <input id="gonextbut" class="but" name="gonextbut" type="button"
                       value="<?php echo $langs['con_go']; ?>"/>
                    ...
                    <div id="addcinput">
                        <p id="addcname"><?php echo $langs['con_name']; ?>：
                            <input id="conname" name="conname" type="text"
                                   value="<?php echo $langs['con_name_def']; ?>"/>
                        </p>
                        ...
                        <div id="con_more">
                            <div id="more_but"><span id="more_icon">▼</span>&nbsp;<a id="showm"
                                                                                     href="javascript:;"><?php echo $langs['con_more']; ?></a>
                            </div>
                            <div id="show_more">
                                <p id="more_line"></p>
                            ...
                            <input id="addcon_but" class="but" name="addcon_but" type="button"
                                   value="< <?php echo $langs['con_add']; ?>"/>
                        </div>
                    </div>
                </div>
                <div id="addconpool_m">
                    ...
                    <div id="addcpinput">
                        <p id="addcpname"><?php echo $langs['conp_name']; ?>：
                            <input id="conpname" name="conpname" type="text"
                                   value="<?php echo $langs['conp_name_def']; ?>"/>
                        </p>

                        <div id="cons"></div>
                        <div id="add_new"><a id="add_new_con"
                                             href="javascript:;"><?php echo $langs['add_new_con']; ?></a></div>
                        <input id="addconp_but" class="but" name="addconp_but" type="button"
                               value="< <?php echo $langs['con_add']; ?>"/>
                    </div>
                </div>
            </div>
