...
<div class="ui-layout-center">
    <iframe src="views/memmanager.php?type=<?php echo $type; ?>&num=0&action=showcon" id="mainframe" name="mainframe"
            width="100%" height="100%" frameborder="0" marginheight="0" scrolling="auto"></iframe>
</div>
...
<div class="ui-layout-west">
    ...
    <div id="leftmenu">
        ...
        <div class="menue">
            ...
            <div class="menulist">
                <ul>
                    <li><a id="showcon" href="javascript:;" class="but_a inithover"><?php echo $langs['con_arg']; ?></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="menue">
            ...
            <div class="menulist">
                <ul>
                    <li><a id="statsmonitor" href="javascript:;" class="but_a"><?php echo $langs['statmonitor']; ?></a>
                    </li>
                    <li><a id="datamonitor" href="javascript:;" class="but_a"><?php echo $langs['datamonitor']; ?></a>
                    </li>
                    <li><a id="hitmonitor" href="javascript:;" class="but_a"><?php echo $langs['hitmonitor']; ?></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="menue">
            ...
            <div class="menulist">
                <ul>
                    ...
                    <li><a id="filtertrav" href="javascript:;" class="but_a"><?php echo $langs['itemfiltravt']; ?></a>
                    </li>
                </ul>
            </div>
        </div>
