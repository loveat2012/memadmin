        ...
        if (md5(serialize($list_check1)) == md5(serialize($list_check2))) {
            ...
            if ($list == false) {
                ...
                <div class="layoutfixed">
                    <div id="itemstit">
                        <span><?php echo $curcon['name']; ?></span><span><?php echo $curcon['host'] . " : " . $curcon['port']; ?></span>
                    </div>
                    <div id="totalnum"><?php echo $langs['itemt_totalnum']; ?>：<span
                            id="totalnumvalue"><?php echo $list_check1['curr_items']; ?></span><span
                            id="numnott"><?php echo $langs['itemt_numnott']; ?></span></div>
                </div>
                <div id="travmenu">
                    <div class="layoutfixed">
                        <div id="totalmenu">
                            ...
                            <div id="slabtotalnum"><?php echo $langs['itemt_slabtotalnum']; ?>：<span
                                    id="slabtotalnumvalue"><?php echo $list[$li]['number']; ?></span></div>
                            <div id="slabtrav"><?php echo $langs['itemt_travtit']; ?><input id="travnum" name="travnum"
                                                                                            type="text"/><?php echo $langs['itemt_travtitnum']; ?>
                                ...
                                <input id="gotrav" class="but" name="gotrav" type="button"
                                       value="<?php echo $langs['itemft_tit']; ?>"/></div>
                        </div>
                        <div class="clear"></div>
                        <div id="filtermenu">
                            <div id="keyfilter">
                                <input id="keyfiltercheck" type="checkbox" name="keyfiltercheck"/><label
                                    for="keyfiltercheck"><span
                                        id="keyfiltertit"><?php echo $langs['itemft_keyfiltertit']; ?></span></label><span
                                    id="keyfilterinputtit"><?php echo $langs['itemft_filter']; ?>：</span><input
                                    id="keyfilterin" name="keyfilterin" type="text"/>
                            </div>
                            <div id="valuefilter">
                                <input id="valuefiltercheck" type="checkbox" name="valuefiltercheck"/><label
                                    for="valuefiltercheck"><span
                                        id="valuefiltertit"><?php echo $langs['itemft_valuefiltertit']; ?></span></label><span
                                    id="valuefilterinputtit"><?php echo $langs['itemft_filter']; ?>：</span><input
                                    id="valuefilterin" name="valuefilterin" type="text"/>
                            </div>
                        </div>
                        <div id="filternot">
                            <div id="perlnot"><?php echo $langs['itemft_perlonly']; ?></div>
                            <div id="filterdemo"><a id="showdemobut"
                                                    href="javascript:;"><?php echo $langs['itemft_demo']; ?></a></div>
                        </div>
                        <div id="notforvalue">
                            <?php echo $langs['itemft_notforvalue']; ?>
                        </div>
                    </div>
                </div>
                <?php
    ...
    if (!$memm->MemConnect($type, $curcon))
        ...
        if ($list[$li_conid] == false) {
            ...
            if (md5(serialize($list[$li_conid])) == md5(serialize($list_check[$li_conid]))) {
                ...
                ?>
                <div id="totalnum"><?php echo $langs['itemt_totalnum']; ?>：<span
                        id="totalnumvalue"><?php echo $list_check[$li_conid]['curr_items']; ?></span></span><span
                        id="numnott"><?php echo $langs['itemt_numnott']; ?></span></div></div>
                <div id="travmenu">
                    <div class="layoutfixed">
                        <div id="totalmenu">
                            <div id="selslab">
                            ...
                            <div id="slabtotalnum"><?php echo $langs['itemt_slabtotalnum']; ?>：<span
                                    id="slabtotalnumvalue"><?php echo $list[$li_conid]['items'][$li]['number']; ?></span>
                            </div>
                            <div id="slabtrav"><?php echo $langs['itemt_travtit']; ?><input id="travnum" name="travnum"
                                                                                            type="text"/><?php echo $langs['itemt_travtitnum']; ?>
                                <span id="charsettit"><?php echo $langs['itemt_charsettit']; ?>：</span>
                                ...
                                <input id="gotrav" class="but" name="gotrav" type="button"
                                       value="<?php echo $langs['itemt_getbut']; ?>"/></div>
                        </div>
                        <div class="clear"></div>
                        <div id="filtermenu">
                            <div id="keyfilter">
...
<div id="pages"></div>
<div id="showdemo">
    <div id="showdemotit"><?php echo $langs['itemft_demo']; ?><a id="closedemo"
                                                                 title="<?php echo $langs['itemft_close']; ?>"
                                                                 href="javascript:;">X</a></div>
    <table id="demotable" cellpadding="2" cellspacing="1">
        <tr>
            <td><?php echo $langs['itemft_demo1']; ?></td>
            <td>/abc/</td>
        </tr>
        <tr>
            <td><?php echo $langs['itemft_demo2']; ?></td>
            <td>/abc/i</td>
        </tr>
        <tr>
            <td><?php echo $langs['itemft_demo3']; ?></td>
            <td>/^abc/</td>
        </tr>
        <tr>
            <td><?php echo $langs['itemft_demo4']; ?></td>
            <td>/abc$/</td>
        </tr>
        <tr>
            <td><?php echo $langs['itemft_demo5']; ?></td>
            <td>/[0-9]$/</td>
        </tr>
        <tr>
            <td><?php echo $langs['itemft_demo6']; ?></td>
            <td>/^[^ab]*$/</td>
        </tr>
    </table>
</div>
