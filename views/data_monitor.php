...
if ($type == 'con') {
    if (!$memm->MemConnect($type, $curcon))
        ...
        if (md5(serialize($list)) == md5(serialize($list_check))) {
            ...
            <div id="statscheck">
                ...
                <div id="checktableframe1">
                    <table id="checktable1" class="checktable" cellpadding="2" cellspacing="1">
                        ...
                        <tr class="check_span">
                            <td colspan="3"><?php echo $langs['datamo_gloarg']; ?></td>
                        </tr>
                        <tr>
                            <td class="checktd"><input type="checkbox" class="checkmo_glo" name="checkbox_monitor[]"
                                                       id="checkbox_c" checked="checked" disabled="disabled"/></td>
                            <td>curr_items</td>
                            <td><?php echo $langs['cs_curr_items']; ?></td>
                        </tr>
                        <tr>
                            <td class="checktd"><input type="checkbox" class="checkmo_glo" name="checkbox_monitor[]"
                                                       id="checkbox_c" checked="checked" disabled="disabled"/></td>
                            <td>bytes</td>
                            <td><?php echo $langs['cs_bytes']; ?></td>
                        </tr>
                        <tr>
                            <td class="checktd"><input type="checkbox" class="checkmo_glo" name="checkbox_monitor[]"
                                                       id="checkbox_c" checked="checked" disabled="disabled"/></td>
                            <td>active_slabs</td>
                            <td><?php echo $langs['slabs_active_slabs']; ?></td>
                        </tr>
                        <tr>
                            <td class="checktd"><input type="checkbox" class="checkmo_glo" name="checkbox_monitor[]"
                                                       id="checkbox_c" checked="checked" disabled="disabled"/></td>
                            <td>total_malloced</td>
                            <td><?php echo $langs['slabs_total_malloced']; ?></td>
                        </tr>
                        <tr class="check_span">
                            <td colspan="3"><?php echo $langs['datamo_slabarg']; ?></td>
                        </tr>
                        <?php
                        ...
                        <tr>
                            <td class="checktd"><input type="checkbox" class="checkmo_glo" name="checkbox_monitor[]"
                                                       id="checkbox_c" checked="checked" disabled="disabled"/></td>
                            <td colspan="2"><?php echo $langs['showmo_data_lostmem']; ?> （ total_chunks * chunk_size -
                                mem_requested ）
                            </td>
                        </tr>
                    </table>
            ...
            <div id="gomonitor">
                <input id="gomonitorbut" class="but" name="gomonitorbut" type="button"
                       value="<?php echo $langs['statsmo_start']; ?>"/>
            </div>
            <?php
        }
    }
                ...
                if (md5(serialize($list[$li])) == md5(serialize($list_check[$li]))) {
                    ...
                    <div id="statscheck">
                        ...
                        <div id="checktableframe1">
                            <table id="checktable1" class="checktable" cellpadding="2" cellspacing="1">
                                <tr id="setidtit">
                                    <td colspan="3"><?php echo $langs['scon_conser'] . " : " . $li; ?></td>
                                </tr>
                                <tr>
                                    <th colspan="1"><?php echo $langs['statsmo_check']; ?></th>
                                    <th colspan="1"><?php echo $langs['cs_arg']; ?></th>
                                ...
                                <tr>
                                    <td class="checktd"><input type="checkbox" class="checkmo_glo"
                                                               name="checkbox_monitor[]" id="checkbox_c"
                                ...
                                <tr>
                                    <td class="checktd"><input type="checkbox" class="checkmo_glo"
                                                               name="checkbox_monitor[]" id="checkbox_c"
                                                               checked="checked" disabled="disabled"/></td>
                                    <td colspan="2"><?php echo $langs['showmo_data_lostmem']; ?> （ total_chunks *
                                        chunk_size - mem_requested ）
                                    </td>
                                </tr>
                            </table>
                        </div>
